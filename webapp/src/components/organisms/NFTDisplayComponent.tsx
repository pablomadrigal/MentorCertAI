  ...
  return (
    <div className="relative group">
      ...
      <Card className="relative w-full max-w-md mx-auto rounded-[7px] z-10 bg-surface">
        <CardHeader>
          <CardTitle className="text-center">{nft.metadata?.name ? nft.metadata.name : ` NFT#${nft.id} `}</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t">
              <p className="text-xs text-text-secondary text-center">NFT ID: {nft.id} Transaction ID: {nft.nft_transaction} • Verified on Blockchain</p>
            </div>
          </div>
        </CardContent>
      </Card>
