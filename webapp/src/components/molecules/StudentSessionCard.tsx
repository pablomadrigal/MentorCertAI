...
export function StudentSessionCard({ session, mentorName, onJoin, onViewCertificate }: StudentSessionCardProps) {
    ...
    const examPassed = session.score !== undefined && session.score >= 70
            ...
            <Card className="h-full rounded-[7px] flex flex-col">
                <CardHeader className="p-4">
                    <div className="flex justify-between items-center">
                        <CardTitle className="text-base truncate" title={`Session with ${mentorName || "Mentor"}`}>
                    ...
                    <div className="space-y-3">
                        <div className="space-y-1">
                            <div>
                                ...
                                <p className="text-sm font-medium truncate" title={session.theme || "General Mentoring"}>
